...
public class student_attendance_sheet extends AppCompatActivity {
    ...
    public void list(ArrayList student, int P, int count, int A) {
        // Toast.makeText(this,NOP+TOC,Toast.LENGTH_LONG).show();
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, android.R.id.text1, student);
